...
class __login__:
    ...
    def __init__(self, auth_token: str, company_name: str, width, height, logout_button_name: str = 'Logout', hide_menu_bool: bool = False, hide_footer_bool: bool = False, lottie_url: str = "https://assets8.lottiefiles.com/packages/lf20_ktwnwv5m.json"):
        ...
        """
        self.auth_token = 'dk_prod_DYEBT7N79V45Z2M6FKPEEN3A0YZC'
        self.company_name = 'CultutalConnect'
        self.width = 200
        self.height = 500
        self.logout_button_name = 'logout'
        self.hide_menu_bool = True
        self.hide_footer_bool = True
        self.lottie_url = 'https: // iconscout.com/lottie/woman-drinking-tea-at-home-9793319?utm_campaign = marketplace & utm_medium = marketplace & utm_source = lottiefiles'
        ...
        with st.form("Forgot Password Form"):
            ...
            if forgot_passwd_submit_button:
                ...
                if email_exists_check == True:
                    ...
                    send_passwd_in_email(self.auth_token, username_forgot_passwd,
    ...
    def reset_password(self) -> None:
        ...
        with st.form("Reset Password Form"):
            ...
            current_passwd = st.text_input(
                "Temporary Password", placeholder='Please enter the password you received in the email')
